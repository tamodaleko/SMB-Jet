        ...
        <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-white sm:text-4xl md:mx-auto">
            <span class="relative inline-block">
              ...
              <span class="relative">We will help you scale your business!</span>
            </span>
          </h2>
          <p class="text-base text-indigo-100 md:text-lg">
            Choose the right package for your business, and our dedicated team will work hard on any challenges you have with your product!
          </p>
        </div>
        <div>
          <a
...
<!-- <div class="bg-opacity-25 grid grid-cols-1">
  ...
  <div class="flex flex-col items-stretch justify-between px-4 py-20 mx-auto max-w-7xl lg:flex-row sm:items-center">
    ...
    <section class="w-full bg-gradient-to-b">
  ...
  <div class="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    ...
    <div class="grid max-w-screen-lg gap-10 md:grid-cols-3 sm:mx-auto">
        ...
        <div class="p-8 bg-gray-900 rounded">
          <div class="mb-4 text-center">
            ...
            <div class="flex items-center justify-center">
              <p class="mr-2 text-4xl font-semibold text-white">
                $3,999
              </p>
      ...
      <div>
        <div class="p-8 bg-gray-900 rounded">
          <div class="mb-4 text-center">
            <p class="text-xl font-medium tracking-wide text-white">Custom Plan</p>
            <div class="flex items-center justify-center">
              <p class="mr-2 text-4xl font-semibold text-white">
                ?
              </p>
          ...
          <button
            type="submit"
            class="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-gray-400 hover:bg-gray-700 focus:shadow-outline focus:outline-none text-gray-900"
          >
            Contact Us
          </button>
        </div>
